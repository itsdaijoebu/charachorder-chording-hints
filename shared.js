(() => {
  const SPECIAL_INPUT_META = {
    ...
    512: { key: "ctrl_left", label: "ctrl_left" },
    513: { key: "left_shift", label: "left_shift" },
    514: { key: "alt_left", label: "alt_left" },
    516: { key: "ctrl_right", label: "ctrl_right" },
    517: { key: "right_shift", label: "right_shift" },
    518: { key: "alt_right", label: "alt_right" },
  ...
  const ICON_FILE_MAP = {
    ...
    ctrl_left: "icons/ctrl.svg",
    ctrl_right: "icons/ctrl.svg",
    left_shift: "icons/shift.svg",
    right_shift: "icons/shift.svg",
    alt_left: "icons/alt.svg",
    alt_right: "icons/alt.svg",
  ...
  function defaultSpecialTokenDescriptions() {
    return {
      ctrl_left: "Control (Left)",
      ctrl_right: "Control (Right)",
